      ...
      <div className="pointer-events-auto w-full max-w-4xl rounded-2xl border border-white/10 bg-[#0a0a0f]/95 px-4 py-4 shadow-2xl backdrop-blur-xl sm:px-6 sm:py-5">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2 sm:gap-3">
            <Link
              href="/cookies"
              className="inline-flex h-10 items-center justify-center rounded-xl border border-white/15 bg-white/5 px-4 text-sm font-medium text-white/90 transition hover:bg-white/10"
            >
              Learn More
            </Link>
            <button
            ...
            <button
              type="button"
              onClick={accept}
              className="inline-flex h-10 items-center justify-center rounded-xl border border-violet-500/40 bg-gradient-to-r from-violet-600/90 to-blue-600/90 px-5 text-sm font-semibold text-white shadow-lg transition hover:from-violet-500 hover:to-blue-500 focus:outline-none focus:ring-2 focus:ring-violet-400/50"
            >
              Accept
            </button>
          </div>
