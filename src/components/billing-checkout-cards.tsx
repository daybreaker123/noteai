...
const btnGradient =
  "flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-purple-500/80 to-blue-500/80 px-4 py-3 text-sm font-semibold text-[var(--inverse-text)] shadow-lg transition hover:from-purple-500 hover:to-blue-500 disabled:opacity-60";

const badgeGradient =
  "rounded-full border border-[var(--border)] bg-gradient-to-r from-purple-500/35 to-blue-500/30 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-[var(--text)]";

const badgeMuted = "rounded-full border border-[var(--border)] bg-[var(--badge-free-bg)] px-2.5 py-0.5 text-[10px] font-medium text-[var(--muted)]";
...
export function BillingCheckoutCards({
  ...
  return (
    <div className="grid gap-5 sm:grid-cols-2">
      ...
      <Card className="flex flex-col border-[var(--border)] bg-[var(--chrome-30)] p-6 backdrop-blur-xl">
        <div className="text-sm font-semibold tracking-tight text-[var(--text)]">Monthly Pro</div>
        ...
        <p className="mt-3 flex-1 text-sm leading-relaxed text-[var(--muted)]">Billed monthly. Cancel anytime.</p>
      ...
      <div
        className={cn(
          ...
          emphasizeAnnual && "ring-2 ring-purple-500/45 ring-offset-2 ring-offset-[var(--bg)]"
        )}
      >
        <div
        ...
        <div
          ...
          aria-hidden
        />
        <Card className="relative flex h-full flex-col border-[var(--border)] bg-[var(--chrome-40)] p-6 backdrop-blur-xl">
          <div className="flex flex-wrap items-center gap-2">
            <span className="text-sm font-semibold tracking-tight text-[var(--text)]">Annual Pro</span>
          ...
          <div className="mt-4 flex items-baseline gap-1">
            <span className="text-4xl font-bold tracking-tight text-[var(--text)]">{formatUsd(proAnnualMonthlyEquivalent)}</span>
            <span className="text-[var(--muted)]">/month</span>
          </div>
          <p className="mt-2 text-sm font-medium text-[var(--muted)]">{formatUsd(PRO_ANNUAL_TOTAL_USD, 0)} billed once per year</p>
